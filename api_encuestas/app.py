...
# ===========================================================
#              MÓDULO 2: PREGUNTAS (REST)
# ===========================================================

# GET /preguntas  -> Lista todas las preguntas
...
# POST /preguntas  -> Crea una pregunta nueva
@app.route("/preguntas", methods=["POST"])
def crear_pregunta():
    data = request.get_json()

    id_encuesta   = data.get("id_encuesta")
    text_pregunta = data.get("text_pregunta")
    ...
    return jsonify({"mensaje": "Pregunta creada", "id_pregunta": nuevo_id}), 201


# PUT /preguntas/<id>  -> Actualiza una pregunta
@app.route("/preguntas/<int:id_pregunta>", methods=["PUT"])
...
# DELETE /preguntas/<id>  -> Borra una pregunta
@app.route("/preguntas/<int:id_pregunta>", methods=["DELETE"])
